...
Cách 2: Tạo mới dự án khi đang ở màn hình Quản lý dự án
...
Người ra người dùng cũng có thể xem Danh sách dự án Public (những dự án cho phép người dùng không là thành viên vẫn có quyền xem với vai trò của Khách) bằng cách bấm chọn sang **Dự án Public**
...
## 6. Tình huống sử dụng: Xem danh sách các ticket của dự án
...
## 7. Tình huống sử dụng: Tạo mới ticket của dự án
...
Bước 3: Người dùng bấm "**Thêm mới ticket**" để tạo thêm 1 ticket. Ticket được tạo mới sẽ hiển thị trong Danh sách ticket theo thứ tự Mới trước cũ sau. Bấm "**Huỷ bỏ**" để xoá các dữ liệu đã nhập. Bấm X để tắt màn hình tạo mới ticket.
